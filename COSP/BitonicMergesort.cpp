...
void COSP::BitonicMergesort::RunMaster(std::vector<int>& vnr) { /* do nothing override run */ }
void COSP::BitonicMergesort::RunSlave(std::vector<int>& vnr)  { /* do nothing override run */ }
